...
public class GlassTuggableView extends CardScrollView {
	 ...
	 */
	public GlassTuggableView(Context context, int layoutResId) {
	 ...
	 */
	public GlassTuggableView(Context context, View view) {
		super(context);
