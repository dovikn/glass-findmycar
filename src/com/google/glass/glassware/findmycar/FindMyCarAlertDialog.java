...
public class FindMyCarAlertDialog extends Dialog {
    	...
    	public boolean onGesture(Gesture gesture) {
    		...
    		if (gesture == Gesture.TAP) {
    			...
    			if (mOnClickListener != null) {
    				...
    				mOnClickListener.onClick(FindMyCarAlertDialog.this, 0);
    			}
    			return true;
    		}
    		return false;
    ...
    public FindMyCarAlertDialog(Context context, int iconResId, int textResId, int footnoteResId,
