...
public class GlassSliderView extends FrameLayout
{
    ...
    private Runnable hideSliderRunnable = new Runnable()
    {
        public void run()
        {
            GlassSliderView.this.hideSlider(true);
        }
    };
    ...
    public GlassSliderView(Context paramContext)
    {
        this(paramContext, null);
    }

    public GlassSliderView(Context paramContext, AttributeSet paramAttributeSet)
    {
        this(paramContext, paramAttributeSet, 0);
    }

    public GlassSliderView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
    {
    ...
    public ImageView getimageView() {
    	return this.indeterminateSlider;
    }
